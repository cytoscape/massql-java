/*
 * MassQL grammar, translated from massql/msql.ebnf (165 lines, Lark EBNF) at pinned
 ...
 * named rejection.
 *
 * Divergences from the Lark source are listed in docs/GRAMMAR_NOTES.md. The two that
 * affect parsing:
...
/* Loose on purpose. Lark distinguishes a molecule formula from the variable X using
   ...
   ever brought in scope (docs/GRAMMAR_NOTES.md). */
