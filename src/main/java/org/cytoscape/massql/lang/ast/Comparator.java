 ...
 * {@code MASSDEFECT}). "A missing comparator defaults to greater-than" therefore refers to an
 * <i>absent qualifier</i> — the implicit {@code > 0} the engine applies to an unqualified intensity
 * column — not to a qualifier that
