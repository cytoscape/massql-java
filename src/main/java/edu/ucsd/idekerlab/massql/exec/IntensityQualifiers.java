 ...
 * Tech_Step9 §3 did not name (Correction C37).
 *
 ...
 * </table>
 *
 * <p>⚠ <b>{@code INTENSITYTICPERCENT} also divides by 100</b> — Tech_Step9 §3 stated the ÷100 rule for
 * {@code INTENSITYPERCENT} only (Correction C37c). Both carry {@code scale = 100.0} in the source.
 *
 ...
 * Tech_Step9's Known traps said "{@code INTENSITYPERCENT} only" (Correction C37d). It never applies to
 ...
 * blanket check (Correction C37e). This is also the whole content of the "missing comparator defaults to
 * greater-than" rule: it is about an absent <i>qualifier</i>, not a qualifier that parsed without a
 * comparator — {@code Comparator} has no {@code NONE} and {@code Qualifier} rejects a null one (C35a).
 */
