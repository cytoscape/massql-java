/**
 * Vendored third-party parser code — the mzML <b>decode path only</b>, from MSDK.
 *
 * <p>Every upstream file here carries a provenance header naming its origin path, the pinned commit,
 * the <b>EPL-1.0</b> licence election (MSDK is dual-licensed LGPL-2.1 OR EPL-1.0) and its exact
 * modifications. {@code docs/VENDORED.md} is the central record, and
