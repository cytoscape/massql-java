 ...
 * 30,000 scans is compared against windowing one with 300, and if {@code mzWindow} were doing
...
class StoreScaleTest {
    ...
    void mzWindowCostDoesNotGrowWithScanCount() {
        ...
        long tSmall = timeWindows(small, 200_000);
        long tLarge = timeWindows(large, 200_000);
    ...
    private static long timeWindows(SpectrumTable t, int iterations) {
        ...
        for (int k = 0; k < iterations; k++) {
            ...
            IntRange r = t.mzWindow(ordinal, centre - 0.005, centre + 0.005);
            hits += r.size();
        }
